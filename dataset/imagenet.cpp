...
int train() {
	...
	network.PushConvolution(48, 11, 1, 0, -20e-2f);
	network.PushActivation(CUDNN_ACTIVATION_RELU);
	network.PushPooling(2, 2);
	network.PushConvolution(128, 5, 1, 0, -20e-2f);
	network.PushActivation(CUDNN_ACTIVATION_RELU);
	network.PushPooling(2, 2);
	network.PushConvolution(192, 3, 1, 0, -20e-2f);
	network.PushActivation(CUDNN_ACTIVATION_RELU);
	network.PushConvolution(192, 3, 1, 0, -20e-2f);
	network.PushActivation(CUDNN_ACTIVATION_RELU);
	network.PushConvolution(128, 3, 1, 0, -20e-2f);
	network.PushActivation(CUDNN_ACTIVATION_RELU);
	network.PushPooling(2, 2);
